  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold mb-3 sm:mb-4 leading-tight px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {principles.map((principle, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="glass-panel p-6 rounded-xl h-full hover:bg-white/10 transition-all duration-300 relative overflow-hidden">
                {/* Background image */}
                ...
                <div className="relative z-10">
                  <div className="mb-5">
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-accent-blue/20 to-accent-green/20 
                                  flex items-center justify-center group-hover:scale-110 transition-transform">
                      <principle.icon className="w-6 h-6 text-accent-cyan" />
                    </div>
                  </div>
